...
class LabeledTextField extends StatefulWidget {
  ...
  final TextEditingController? controller; // Accept a controller
        ...
        TextField(
          ...
          decoration: InputDecoration(
            ...
            focusedBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(12.0),
              borderSide: const BorderSide(color: Color.fromRGBO(120, 82, 174, 1.0), width: 2.0),
            ),
            ...
            disabledBorder: OutlineInputBorder(
              borderRadius: BorderRadius.circular(12.0),
              borderSide: const BorderSide(color: Color.fromRGBO(120, 82, 174, 1.0), width: 0.0),
            ),
